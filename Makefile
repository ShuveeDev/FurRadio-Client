#############################################################################
# Makefile for building: FurRadio.app/Contents/MacOS/FurRadio
# Generated by qmake (3.1) (Qt 6.10.1)
# Project:  RadioPlayer.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile RadioPlayer.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = FurRadio1.0.0
DISTDIR = /Users/shuvee/Desktop/C++\ Learn/.tmp/FurRadio1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		RadioPlayer.pro  main.cpp
QMAKE_TARGET  = FurRadio
DESTDIR       = 
TARGET        = FurRadio.app/Contents/MacOS/FurRadio

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 26.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/shuvee/Desktop/C++ Learn/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/shuvee/Desktop/C++ Learn/RadioPlayer.pro
...
FurRadio.app/Contents/MacOS/FurRadio:  $(OBJECTS)  
	@test -d FurRadio.app/Contents/MacOS/ || mkdir -p FurRadio.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: RadioPlayer.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile RadioPlayer.pro
...
FurRadio.app/Contents/PkgInfo: 
	@test -d FurRadio.app/Contents || mkdir -p FurRadio.app/Contents
	@$(DEL_FILE) FurRadio.app/Contents/PkgInfo
	@echo "APPL????" > FurRadio.app/Contents/PkgInfo
FurRadio.app/Contents/Info.plist: 
	@test -d FurRadio.app/Contents || mkdir -p FurRadio.app/Contents
	@$(DEL_FILE) FurRadio.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.FurRadio,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.FurRadio,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,FurRadio.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},FurRadio.icns,g" -e "s,@EXECUTABLE@,FurRadio,g" -e "s,@LIBRARY@,FurRadio,g" -e "s,\$${EXECUTABLE_NAME},FurRadio,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >FurRadio.app/Contents/Info.plist
FurRadio.app/Contents/Resources/FurRadio.icns: FurRadio.icns
	@test -d FurRadio.app/Contents/Resources/ || mkdir -p FurRadio.app/Contents/Resources/
	@$(DEL_FILE) FurRadio.app/Contents/Resources/FurRadio.icns
	@$(COPY_FILE) FurRadio.icns FurRadio.app/Contents/Resources/FurRadio.icns

all: Makefile \
		FurRadio.app/Contents/PkgInfo \
		FurRadio.app/Contents/Info.plist \
		FurRadio.app/Contents/Resources/FurRadio.icns FurRadio.app/Contents/MacOS/FurRadio
